...
set(_configure_command
  ...
  "-DTEST_HELPER=apply"
  "-DTEST_CUDA_CACHE_MODE=${TEST_CUDA_CACHE_MODE}"
...
if(_result EQUAL 0)
  message(FATAL_ERROR
    "Invalid CUDA cache mode '${TEST_CUDA_CACHE_MODE}' unexpectedly "
...
if(NOT _normalized_diagnostic MATCHES "${EXPECTED_ERROR_PATTERN}")
  message(FATAL_ERROR
    "Invalid CUDA cache mode failed with an unexpected diagnostic.\n"
    "Expected pattern: ${EXPECTED_ERROR_PATTERN}\n"
    "Actual output:\n${_diagnostic}")
endif()

message(STATUS
  "Invalid CUDA cache mode '${TEST_CUDA_CACHE_MODE}' produced the expected "
  "diagnostic.")
